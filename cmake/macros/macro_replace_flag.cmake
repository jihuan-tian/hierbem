...
# found in the file LICENSE.md at the top level directory of deal.II.
#
# ---------------------------------------------------------------------
...
# variable.
#
# Usage: REPLACE_FLAG(variable flag replacement)
#
...
macro(REPLACE_FLAG _variable _flag _replacement)
  ...
  if(NOT "${_replacement_stripped}" STREQUAL "")
    string(REPLACE " ${_flag2} " " ${_replacement_stripped} " ${_variable}
                   "${${_variable}}")
  else()
