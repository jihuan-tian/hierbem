...
TEST_CASE("Solve Laplace problem with Neumann boundary condition", "[laplace]")
{
  ...
  {
    run_neumann_hmatrix(IterativeSolverVmultType::SerialRecursive);
  ...
  {
    run_neumann_hmatrix(IterativeSolverVmultType::SerialIterative);
  ...
  {
    run_neumann_hmatrix(IterativeSolverVmultType::TaskParallel);
