...
/**
 * @file helmholtz-neumann-hmatrix-op-precond.cc
 * @brief Verify solving the complex valued Helmholtz acoustic problem with
 * Neumann boundary condition using H-matrix based BEM. Operator preconditioning
 * is used.
 *
 * @ingroup test_cases
 * @author Jihuan Tian
...
TEST_CASE(
  "Solve complex valued Helmholtz acoustic problem with Neumann boundary condition using operator preconditioning",
  "[helmholtz-acoustic]")
{
