...
/**
 * @file helmholtz-dirichlet-hmatrix-op-precond.cc
 * @brief Verify solving the complex valued Helmholtz acoustic problem with
 * Dirichlet boundary condition using H-matrix based BEM. Operator
...
TEST_CASE(
  "Solve complex valued Helmholtz acoustic problem with Dirichlet boundary condition using operator preconditioning",
  "[helmholtz-acoustic]")
{
