...
load "/home/jihuan/Projects/hierbem/tests/functions/helmholtz-acoustic/dirichlet-hmatrix-op-precond/reference.output";
solution_ref = solution;
## Load computation solution
load "helmholtz-dirichlet-hmatrix-op-precond.output";
