...
/**
 * \file neumann-hmatrix.cc
 * \brief Baseline test for solving the Laplace problem with Neumann boundary
...
main(int argc, char *argv[])
{
  ...
  ConfLaplaceBEM bem_params{opts.refinement,
                            ...
                            false};
  ConfHMatrix    hmat_params{64, 64, 8, 4, 0.8, 5, 0, 0.01, false, 10};
  ConfHMatrix    hmat_preconditioner_params{
    64, 64, 8, 4, 1.0, 2, 0, 0.1, false, 10};
