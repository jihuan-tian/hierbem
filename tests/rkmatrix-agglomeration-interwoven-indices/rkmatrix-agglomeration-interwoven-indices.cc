...
main()
{
   ...
   * Output the matrices.
   */
  M11_rk.print_formatted_to_mat(std::cout, "M11_rk", 5, false, 10, "0");
  M12_rk.print_formatted_to_mat(std::cout, "M12_rk", 5, false, 10, "0");
  M21_rk.print_formatted_to_mat(std::cout, "M21_rk", 5, false, 10, "0");
  M22_rk.print_formatted_to_mat(std::cout, "M22_rk", 5, false, 10, "0");
