/**
 * \file hmatrix-Hvmult-hermite-symm-serial-iterative.cc
 * \brief Verify parallel Hermite transposed \hmatrix/vector multiplication. The
 * \hmatrix is Hermite symmetric and only its lower triangular part is stored.
 *
...
extern void
run_hmatrix_Hvmult_hermite_symm_serial_iterative();

static constexpr int FUZZING_TIMES = 50;
TEST_CASE(
  "Hermite transposed Hermite symmetric H-matrix/vector multiplication in serial by iteration",
  "[hmatrix]")
{
