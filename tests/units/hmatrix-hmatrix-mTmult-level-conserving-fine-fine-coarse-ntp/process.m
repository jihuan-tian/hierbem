...
load_packages;
load hmatrix-hmatrix-mTmult-level-conserving-fine-fine-coarse-ntp.output;
...
print("hmatrix-hmatrix-mTmult-level-conserving-fine-fine-coarse-ntp.png", "-dpng", "-r600");
