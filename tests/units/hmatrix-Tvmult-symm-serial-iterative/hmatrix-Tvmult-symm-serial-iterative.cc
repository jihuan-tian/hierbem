...
/**
 * \file hmatrix-Tvmult-symm-serial-iterative.cc
 * \brief Verify serial transposed \hmatrix/vector multiplication by iterating
 * over the leaf set. The \hmatrix is symmetric and only its lower triangular
 * part is stored.
 *
...
extern void
run_hmatrix_Tvmult_symm_serial_iterative();

static constexpr int FUZZING_TIMES = 50;
TEST_CASE(
  "Transposed symmetric H-matrix/vector multiplication in serial by iteration",
  "[hmatrix]")
{
