...
/**
 * \file hmatrix-vmult-hermite-symm-serial-iterative.cc
 * \brief Verify parallel \hmatrix/vector multiplication. The \hmatrix is
 * Hermite symmetric and only its lower triangular part is stored.
 *
...
extern void
run_hmatrix_vmult_hermite_symm_serial_iterative();

static constexpr int FUZZING_TIMES = 50;
TEST_CASE(
  "Hermite symmetric H-matrix/vector multiplication in serial by iteration",
  "[hmatrix]")
{
