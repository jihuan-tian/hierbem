/**
 * \file hmatrix-tvmult-symm-parallel.cc
 * \brief Verify parallel transposed \hmatrix/vector multiplication. The
 * \hmatrix is symmetric and only its lower triangular part is stored.
 *
...
TEST_CASE("Transposed symmetric H-matrix/vector multiplication in parallel",
          "[hmatrix]")
{
