...
/**
 * \file hmatrix-add-rkmatrix-into-new-hmatrix.cc
 * \brief Verify the addition of a rank-k matrix and an \hmatrix into a new
 * \hmatrix.
...
main()
{
  ...
  H_full.print_formatted_to_mat(std::cout, "H_full", 10, false, 20, "0");

  /**
   * Add the rank-k matrix into the \hmatrix.
   */
  H.add(H_sum, R, fixed_rank_k);
  ...
  H_sum_full.print_formatted_to_mat(
    std::cout, "H_sum_full", 10, false, 20, "0");
