/**
 * \file hmatrix-vmult-triu-serial-iterative.cc
 * \brief Verify serial upper triangular \hmatrix/vector multiplication by
...
extern void
run_hmatrix_vmult_triu_serial_iterative();

static constexpr int FUZZING_TIMES = 50;
TEST_CASE(
  "Upper triangular H-matrix/vector multiplication in serial by iteration",
  "[hmatrix]")
{
