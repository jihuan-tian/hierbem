...
void
run_hmatrix_Hvmult_tril_serial_iterative()
{
  std::ofstream ofs("hmatrix-Hvmult-tril-serial-iterative.output");
   ...
   */
  M_complex.set_property(LAPACKSupport::Property::lower_triangular);
   ...
   */
  H_complex.prepare_for_vmult_or_tvmult(false, true);
  H_complex.Hvmult_serial_iterative(0.3, y_complex, 1.5, x_complex);
  print_vector_to_mat(ofs, "y1_cpp_complex", y_complex);
  H_complex.Hvmult_serial_iterative(std::complex<double>(0.3, 0.2),
                                    y_complex,
  ...
  H_complex.Hvmult_serial_iterative(0.3,
                                    y_complex,
                                    std::complex<double>(1.5, 2.1),
                                    x_complex);
