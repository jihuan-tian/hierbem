...
load_packages;
load "hmatrix-hmatrix-alpha-mTmult-level-conserving-all-fine-ntp-member-function-call.output";
...
title("H3=alpha*H1*H2^T");

print("hmatrix-hmatrix-alpha-mTmult-level-conserving-all-fine-ntp-member-function-call.png", "-dpng", "-r600");
