/**
 * \file hmatrix-build-from-aca-with-mass-matrix-smp.cc
 * \brief Build \hmatrices for SLP and DLP kernels based on the mesh data from
 * @p Erichsen1996Efficient Example 2. In addition, the mass matrix scaled by
 * 0.5 is added to the DLP matrix. This tester enables SMP parallelization.
 *
...
main(int argc, char *argv[])
{
  ...
  options_description opts(
    "hmatrix-build-from-aca-with-mass-matrix-smp options");
  ...
  testcase.assemble_system_as_hmatrices_with_mass_matrix_smp(
