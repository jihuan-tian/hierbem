/**
 * \file hmatrix-block-triangular-forward-substitution.cc
 * \brief Verify forward substitution of a lower block triangle \hmatrix. The
...
main()
{
  ...
  /**
   * Solve the matrix using forward substitution for block triangular matrices.
   */
  Vector<double> x;
  H.solve_block_triangular_by_forward_substitution(x, b, false);
