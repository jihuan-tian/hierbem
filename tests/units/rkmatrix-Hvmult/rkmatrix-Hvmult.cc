/**
 * \file rkmatrix-Hvmult.cc
 * \brief Verify the multiplication of an Hermite transposed rank-k matrix with
 * a vector.
 * \ingroup rkmatrices
 *
 * \author Jihuan Tian
...
TEST_CASE("Verify Hvmult for RkMatrix", "[linalg]")
{
  INFO("*** test start");
