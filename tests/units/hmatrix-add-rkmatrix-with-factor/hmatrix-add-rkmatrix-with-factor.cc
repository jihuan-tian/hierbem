/**
 * \file hmatrix-add-rkmatrix-with-factor.cc
 *
...
main()
{
  ...
  H_full.print_formatted_to_mat(
    std::cout, "H_full_before_add", 10, false, 20, "0");

  /**
   * Add the rank-k matrix into the \hmatrix.
   */
  double b = 3.5;
  H.add(b, R, fixed_rank_k);
  ...
  H.convertToFullMatrix(H_full);
  H_full.print_formatted_to_mat(
    std::cout, "H_full_after_add", 10, false, 20, "0");
