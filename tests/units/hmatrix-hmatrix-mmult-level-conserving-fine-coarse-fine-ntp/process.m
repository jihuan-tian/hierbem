clear all;
load hmatrix-hmatrix-mmult-level-conserving-fine-coarse-fine-ntp.output;
...
print("hmatrix-hmatrix-mmult-level-conserving-fine-coarse-fine-ntp.png", "-dpng", "-r600");
