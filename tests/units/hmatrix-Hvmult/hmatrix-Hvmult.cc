/**
 * \file hmatrix-Hvmult.cc
 * \brief Verify Hermite transposed \hmatrix/vector multiplication.
 *
...
TEST_CASE("Hermite transposed H-matrix/vector multiplication", "[hmatrix]")
{
