...
/**
 * \file hmatrix-vmult-hermite-symm-parallel.cc
...
extern void
run_hmatrix_vmult_hermite_symm_parallel();

static constexpr int FUZZING_TIMES = 50;
TEST_CASE("Hermite symmetric H-matrix/vector multiplication in parallel",
          "[hmatrix]")
{
