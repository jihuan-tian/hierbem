/**
 * \file hmatrix-vmult-triu-parallel.cc
 * \brief Verify parallel upper triangular \hmatrix/vector multiplication.
 *
...
TEST_CASE("Upper triangular H-matrix/vector multiplication in parallel",
          "[hmatrix]")
{
