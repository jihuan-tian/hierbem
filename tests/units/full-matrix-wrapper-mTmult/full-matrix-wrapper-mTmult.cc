...
/**
 * @file full-matrix-wrapper-mTmult.cu
...
main()
{
  ...
  PlatformShared::FullMatrixWrapper<double> B(B_data, 2, 3);
  PlatformShared::FullMatrixWrapper<double> C(C_data, 3, 2);
  PlatformShared::FullMatrixWrapper<double> C_adding(C_adding_data, 3, 2);
