 ...
 * \brief Verify parallel Hermite transposed \hmatrix/vector multiplication.
 *
...
extern void
run_hmatrix_Hvmult_parallel();

static constexpr int FUZZING_TIMES = 50;
TEST_CASE("Hermite transposed H-matrix/vector multiplication in parallel",
          "[hmatrix]")
{
