/**
 * \file hmatrix-block-triangular-backward-substitution-unit-diag.cc
 * \brief Verify backward substitution of an unit upper block triangle \hmatrix.
...
main()
{
   ...
   */
  Vector<double> x;
  H.solve_block_triangular_by_backward_substitution(x, b, true);
