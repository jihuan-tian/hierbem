clear all;
load hmatrix-hmatrix-mTmult-level-conserving-coarse-coarse-fine-ntp.output;
...
print("hmatrix-hmatrix-mTmult-level-conserving-coarse-coarse-fine-ntp.png", "-dpng", "-r600");
