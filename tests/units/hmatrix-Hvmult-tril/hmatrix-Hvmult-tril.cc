...
/**
 * \file hmatrix-Hvmult-tril.cc
 * \brief Verify Hermite transposed lower triangular \hmatrix/vector
 * multiplication.
 *
...
extern void
run_hmatrix_Hvmult_tril();

static constexpr int FUZZING_TIMES = 5;
TEST_CASE("Hermite transposed lower triangular H-matrix/vector multiplication",
          "[hmatrix]")
{
