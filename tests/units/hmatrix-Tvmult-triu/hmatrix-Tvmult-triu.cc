/**
 * \file hmatrix-tvmult-triu.cc
 * \brief Verify transposed upper triangular \hmatrix/vector multiplication.
 *
...
TEST_CASE("Transposed upper triangular H-matrix/vector multiplication",
          "[hmatrix]")
{
