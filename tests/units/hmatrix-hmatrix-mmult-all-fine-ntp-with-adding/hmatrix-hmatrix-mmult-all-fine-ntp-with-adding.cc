/**
 * \file hmatrix-hmatrix-mmult-all-fine-ntp-with-adding.cc
...
main()
{
  ...
  /**
   * Before perform the multiplication, we make a copy from \p H1 as the initial
   * value of the result matrix \p H.
   */
  HMatrix<3, double> H(H1);

  /**
   * Multiply the two H-matrices \p H1 and \p H2.
   */
  H1.mmult(H, H2, bc_tree1, bc_tree2, bc_tree3, fixed_rank_k, true);
