...
load_packages;
load hmatrix-hmatrix-mmult-level-conserving-coarse-fine-coarse-ntp.output;
...
print("hmatrix-hmatrix-mmult-level-conserving-coarse-fine-coarse-ntp.png", "-dpng", "-r600");
