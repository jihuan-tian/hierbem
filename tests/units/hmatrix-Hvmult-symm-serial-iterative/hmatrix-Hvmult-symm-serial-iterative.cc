/**
 * \file hmatrix-Hvmult-symm-serial-iterative.cc
 * \brief Verify serial Hermite transposed \hmatrix/vector multiplication by
 * iterating over the leaf set. The \hmatrix is symmetric and only its lower
...
extern void
run_hmatrix_Hvmult_symm_serial_iterative();

static constexpr int FUZZING_TIMES = 50;
TEST_CASE(
  "Hermite transposed symmetric H-matrix/vector multiplication in serial by iteration",
  "[hmatrix]")
{
