/**
 * \file hmatrix-upper-write-leaf-set-by-iteration-hilbert-curve.cu
 ...
 * curve.
 *
 * The \hmatrix in this test case is upper triangular.
 *
 * \ingroup
 * \author Jihuan Tian
 * \date 2024-03-11
...
main()
{
  ...
  // Execute script `gen_upper_matrix.m` to generate M.dat
  inst.source_file(SOURCE_DIR "/gen_upper_matrix.m");
  ...
  /**
   * Create a rank-1 HMatrix, whose property is automatically set to @p upper_triangular.
   */
