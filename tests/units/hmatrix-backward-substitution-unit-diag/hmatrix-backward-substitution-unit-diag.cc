...
/**
 * \file hmatrix-backward-substitution-unit-diag.cc
 * \brief Verify backward substitution of an unit upper triangle \hmatrix. The
...
extern void
run_hmatrix_backward_substitution_unit_diag();

static constexpr int FUZZING_TIMES = 5;
TEST_CASE(
  "Solve normalized upper triangular H-matrix using backward substitution",
  "[hmatrix]")
{
