...
/**
 * @file full-matrix-wrapper-Tmmult.cu
 * @brief Verify matrix-matrix multiplication with the first operand transposed.
 *
...
main()
{
  ...
  PlatformShared::FullMatrixWrapper<double> A(A_data, 3, 2);
