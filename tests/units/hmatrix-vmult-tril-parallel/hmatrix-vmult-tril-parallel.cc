/**
 * \file hmatrix-vmult-tril-parallel.cc
 * \brief Verify parallel lower triangular \hmatrix/vector multiplication.
 *
...
TEST_CASE("Lower triangular H-matrix/vector multiplication in parallel",
          "[hmatrix]")
{
