/**
 * \file hmatrix-vmult-tril-serial-iterative.cc
 * \brief Verify serial lower triangular \hmatrix/vector multiplication by
...
TEST_CASE(
  "Lower triangular H-matrix/vector multiplication in serial by iteration",
  "[hmatrix]")
{
