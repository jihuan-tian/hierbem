/**
 * \file hmatrix-Hvmult-triu-serial-iterative.cc
 * \brief Verify serial Hermite transposed upper triangular \hmatrix/vector
...
TEST_CASE(
  "Hermite transposed upper triangular H-matrix/vector multiplication in serial by iteration",
  "[hmatrix]")
{
