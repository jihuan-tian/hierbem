/**
 * \file hmatrix-Hvmult-tril-parallel.cc
 * \brief Verify parallel Hermite transposed lower triangular \hmatrix/vector
 * multiplication.
 *
...
extern void
run_hmatrix_Hvmult_tril_parallel();

static constexpr int FUZZING_TIMES = 50;
TEST_CASE(
  "Hermite transposed lower triangular H-matrix/vector multiplication in parallel",
  "[hmatrix]")
{
