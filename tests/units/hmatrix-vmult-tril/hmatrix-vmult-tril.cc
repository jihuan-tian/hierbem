/**
 * \file hmatrix-vmult-tril.cc
 * \brief Verify lower triangular \hmatrix/vector multiplication.
 *
...
TEST_CASE("Lower triangular H-matrix/vector multiplication", "[hmatrix]")
{
