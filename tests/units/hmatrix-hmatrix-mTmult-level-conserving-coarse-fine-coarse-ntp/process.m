...
load_packages;
load hmatrix-hmatrix-mTmult-level-conserving-coarse-fine-coarse-ntp.output;
...
print("hmatrix-hmatrix-mTmult-level-conserving-coarse-fine-coarse-ntp.png", "-dpng", "-r600");
