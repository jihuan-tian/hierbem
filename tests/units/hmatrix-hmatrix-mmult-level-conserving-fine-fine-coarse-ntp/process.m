clear all;
load hmatrix-hmatrix-mmult-level-conserving-fine-fine-coarse-ntp.output;
...
print("hmatrix-hmatrix-mmult-level-conserving-fine-fine-coarse-ntp.png", "-dpng", "-r600");
