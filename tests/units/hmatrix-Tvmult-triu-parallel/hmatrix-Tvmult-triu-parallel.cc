/**
 * \file hmatrix-tvmult-triu-parallel.cc
 * \brief Verify parallel transposed upper triangular \hmatrix/vector
 * multiplication.
 *
...
TEST_CASE(
  "Transposed upper triangular H-matrix/vector multiplication in parallel",
  "[hmatrix]")
{
