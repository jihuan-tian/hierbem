/**
 * \file hmatrix-Hvmult-triu-parallel.cc
 * \brief Verify parallel Hermite transposed upper triangular \hmatrix/vector
 * multiplication.
 *
...
extern void
run_hmatrix_Hvmult_triu_parallel();

static constexpr int FUZZING_TIMES = 50;
TEST_CASE(
  "Hermite transposed upper triangular H-matrix/vector multiplication in parallel",
  "[hmatrix]")
{
