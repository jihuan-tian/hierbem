/**
 * \file run-hmatrix-vmult-symm-serial-iterative.cc
 * \brief Verify serial \hmatrix/vector multiplication by iterating over the
...
TEST_CASE("Symmetric H-matrix/vector multiplication in serial by iteration",
          "[hmatrix]")
{
