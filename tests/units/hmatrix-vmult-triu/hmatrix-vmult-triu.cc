/**
 * \file hmatrix-vmult-triu.cc
 * \brief Verify upper triangular \hmatrix/vector multiplication.
 *
...
TEST_CASE("Upper triangular H-matrix/vector multiplication", "[hmatrix]")
{
