...
/**
 * @file full-matrix-wrapper-Tvmult.cu
...
main()
{
  ...
  PlatformShared::FullMatrixWrapper<double> A(A_data, 3, 4);
  PlatformShared::VectorWrapper<double>     v(v_data, 3);
  PlatformShared::VectorWrapper<double>     w(w_data, 4);
  PlatformShared::VectorWrapper<double>     w_adding(w_adding_data, 4);
