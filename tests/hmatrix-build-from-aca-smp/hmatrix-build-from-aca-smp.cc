/**
 * \file hmatrix-build-from-aca-smp.cc
 * \brief Build \hmatrices for SLP and DLP kernels based on the mesh data from
 * @p Erichsen1996Efficient Example 2. This tester enables SMP parallelization.
 *
...
main(int argc, char *argv[])
{
  ...
  options_description opts("hmatrix-build-from-aca-smp options");
  ...
  testcase.assemble_system_as_hmatrices_smp(enable_build_symmetric_hmat);
