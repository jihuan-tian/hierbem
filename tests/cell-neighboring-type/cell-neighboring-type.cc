...
int main()
{
  ...
  FullMatrix<unsigned int> cell_neighboring_type_matrix(n_active_cells, n_active_cells);
  ...
  deallog << "Calculate cell neighboring type using vertex indices..." << std::endl;
  ...
  deallog << "Calculate cell neighboring type using vertex dof indices..." << std::endl;
  cell_neighboring_type_matrix.print(deallog);
