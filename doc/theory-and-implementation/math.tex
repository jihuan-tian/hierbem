...
% =: (\eqqcolon), extensible harpoons, etc.
...
\@ifclassloaded{beamer}{\newtheorem{remark}{Remark}}
{
  ...
  \usepackage[standard, framed, amsmath, hyperref, thmmarks]{ntheorem}
