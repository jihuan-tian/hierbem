...
$(\vect{\pdiff}x_U^1,\cdots,\vect{\pdiff}x_U^n)$, the matrix formulation of the
...
\begin{Example}[Basis of spherical coordinate chart]
  ...
  matrix and $\vect{\pdiff}\theta$ is the second column.
\end{Example}
