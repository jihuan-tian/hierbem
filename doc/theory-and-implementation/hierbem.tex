...
belongs to only one cell and Equation \ref{eq:bilinear-form-matrix-entry-cell-pairs} has a
simpler form
\begin{equation}
...
$i$. Similarly, the index of t he corresponding shape function in $\tau_j$ is $k(j)$.
