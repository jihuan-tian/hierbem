 ...
 * @author Jihuan Tian
 */
#ifndef INCLUDE_HBLOCKMATRIX_SKEW_SYMM_H_
#define INCLUDE_HBLOCKMATRIX_SKEW_SYMM_H_
 ...
 * \end{pmatrix},
 * \f]
 * where \f$M_{11}\f$ and \f$M_{22}\f$ are symmetric and positive definite, the
 * matrix block \f$M_{21}=-M_{12}^T\f$ is not stored.
 */
