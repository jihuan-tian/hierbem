#ifndef INCLUDE_SEQUENCE_PARTITION_H_
#define INCLUDE_SEQUENCE_PARTITION_H_
      ...
      if (n < 1)
        {
          throw std::invalid_argument(
            "The length of the sequence must be >=1: " + std::to_string(n));
        }
      if (p < 1 || p > n)
        {
          throw std::invalid_argument(
...
#endif /* INCLUDE_SEQUENCE_PARTITION_H_ */
