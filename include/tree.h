...
#ifndef HIERBEM_INCLUDE_TREE_H_
#define HIERBEM_INCLUDE_TREE_H_
...
void
Preorder_for_memory_consumption(TreeNode<T, N> *p, Number &accumulated_results)
{
  if (p != nullptr)
    {
      accumulated_results += p->memory_consumption();
