 ...
 * @author Jihuan Tian
 */
#ifndef HIERBEM_INCLUDE_UTILITIES_GENERIC_FUNCTORS_H_
#define HIERBEM_INCLUDE_UTILITIES_GENERIC_FUNCTORS_H_
 ...
 * @param starting_value The starting value to be placed into the first element
 * of the list
...
#endif // HIERBEM_INCLUDE_UTILITIES_GENERIC_FUNCTORS_H_
