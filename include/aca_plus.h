...
namespace IdeoBEM
{
   ...
   * the function there is no reinitialization of this vector anymore.
   * 2. This version is especially for assembling the regularized hyper-singular
   * matrix with the stabilization term.}
   *
   * @param row_vector
   * @param kernel
   * @param kernel_factor
   ...
   * @param kernel
   * @param factor
   * @param row_dof_indices The list of row DoF indices in the global internal DoF numbering.
   * @param col_dof_index The column DoF index in the global internal DoF numbering.
   * @param kx_dof_to_cell_topo
   * @param ky_dof_to_cell_topo
   * @param bem_values
   * @param kx_dof_handler
   ...
   * rank-k matrices will be built using ACA+.
   *
   * \mynote{1. In this version, the computation of the list of \hmatnodes in
   * the leaf set is parallelized.
   * 2. This version is especially for assembling the regularized hyper-singular
   * matrix with the stabilization term.}
   *
   * @param thread_num
