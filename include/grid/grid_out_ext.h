 ...
 * @author Jihuan Tian
 */
#ifndef HIERBEM_INCLUDE_GRID_GRID_OUT_EXT_H_
#define HIERBEM_INCLUDE_GRID_GRID_OUT_EXT_H_
...
write_msh_correct(const Triangulation<dim, spacedim> &tria, std::ostream &out)
{
  ...
  */
  ...
  /*
    ...
    vertices, 4 with the edges and 1 with the face). 11 Second order
    tetrahedron (10 nodes: 4 associated with the vertices and 6 with the
    edges). 12 Second order hexahedron (27 nodes: 8 associated with the
    vertices, 12 with the edges, 6 with the faces and 1 with the volume). 13
    Second order prism (18 nodes: 6 associated with the vertices, 9 with the
    edges and 3 with the quadrangular faces). 14 Second order pyramid (14
    nodes: 5 associated with the vertices, 8 with the edges and 1 with the
    quadrangular face). 15 Point (1 node).
  */
...
#endif // HIERBEM_INCLUDE_GRID_GRID_OUT_EXT_H_
