 ...
 * @author Jihuan Tian
 */
#ifndef HIERBEM_INCLUDE_GRID_GRID_IN_EXT_H_
#define HIERBEM_INCLUDE_GRID_GRID_IN_EXT_H_
                ...
                for (unsigned int &vertex :
                  ...
                  if (vertex_indices.find(vertex) != vertex_indices.end())
                  ...
                  else
                    {
                      ...
                      Assert(
                        false,
                        (typename GridIn<dim, spacedim>::ExcInvalidVertexIndex(
...
#endif // HIERBEM_INCLUDE_GRID_GRID_IN_EXT_H_
