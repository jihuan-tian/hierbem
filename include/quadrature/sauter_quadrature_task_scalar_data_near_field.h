...
/**
 * @file sauter_quadrature_task_scalar_data_near_field.h
 * @brief Class for the scalar data used in Sauter quadrature tasks when
 * assembling near field H-matrix blocks.
...
#ifndef HIERBEM_INCLUDE_QUADRATURE_SAUTER_QUADRATURE_TASK_SCALAR_DATA_NEAR_FIELD_H_
#define HIERBEM_INCLUDE_QUADRATURE_SAUTER_QUADRATURE_TASK_SCALAR_DATA_NEAR_FIELD_H_
 ...
 * used in each quadrature task for near field H-matrix blocks.
 */
class SauterQuadratureTaskScalarDataNearField
{
public:
  /**
   * Cell index of \f$K_x\f$.
   */
  types::global_cell_index kx_cell_index_global;
  /**
   * Cell index of \f$K_y\f$.
   */
  types::global_cell_index ky_cell_index_global;
  /**
...
#endif // HIERBEM_INCLUDE_QUADRATURE_SAUTER_QUADRATURE_TASK_SCALAR_DATA_NEAR_FILED_H_
