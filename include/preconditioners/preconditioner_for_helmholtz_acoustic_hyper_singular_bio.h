...
/**
 * @file preconditioner_for_helmholtz_acoustic_hyper_singular_bio.h
 * @brief Dual mesh operator preconditioner for the hyper singular boundary
 * integral operator in the Helmholtz acoustic equation.
 *
 * @date 2025-12-26
 * @author Jihuan Tian
 */

#ifndef HIERBEM_INCLUDE_PRECONDITIONERS_PRECONDITIONER_FOR_HELMHOLTZ_ACOUSTIC_HYPER_SINGULAR_BIO_H_
 ...
 * the hyper singular boundary integral operator in the Helmholtz acoustic
 * equation.
 *
...
class HelmholtzAcousticHyperSingularPreconditioner
...
#endif // HIERBEM_INCLUDE_PRECONDITIONERS_PRECONDITIONER_FOR_HELMHOLTZ_ACOUSTIC_HYPER_SINGULAR_BIO_H_
