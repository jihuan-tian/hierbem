 ...
 * @author Jihuan Tian
 */
#ifndef HIERBEM_INCLUDE_CAD_MESH_GMSH_MANIPULATION_H_
#define HIERBEM_INCLUDE_CAD_MESH_GMSH_MANIPULATION_H_
...
#include "config.h"
#include "linear_algebra/vector_arithmetic.h"
...
public:
   ...
   */
  static void
  get_oriented_volume_boundaries(const EntityTag         volume_tag,
...
#endif // HIERBEM_INCLUDE_CAD_MESH_GMSH_MANIPULATION_H_
