...
#ifndef HIERBEM_INCLUDE_LINEAR_ALGEBRA_BLAS_HELPERS_H_
#define HIERBEM_INCLUDE_LINEAR_ALGEBRA_BLAS_HELPERS_H_
...
#endif // HIERBEM_INCLUDE_LINEAR_ALGEBRA_BLAS_HELPERS_H_
