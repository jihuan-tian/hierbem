...
#ifndef HIERBEM_INCLUDE_CLUSTER_TREE_BLOCK_CLUSTER_H_
#define HIERBEM_INCLUDE_CLUSTER_TREE_BLOCK_CLUSTER_H_
...
public:
   ...
   *
   * @param tau_node The pointer associated to the node in the cluster tree
   * \f$T(I)\f$, which holds the cluster \f$\tau\f$.
   * @param sigma_node The pointer associated to the node in the cluster tree
   * \f$T(J)\f$, which holds the cluster \f$\sigma\f$.
   */
  BlockCluster(
  ...
  /**
   * Determine if the block cluster is admissible.
   *
   * @param eta Admissibility constant.
   */
  void
  check_is_admissible(Number eta);
   ...
   */
  bool
  is_admissible_or_small(Number eta, unsigned int n_min);
...
template <int spacedim, typename Number>
void
BlockCluster<spacedim, Number>::check_is_admissible(Number eta)
{
...
template <int spacedim, typename Number>
bool
BlockCluster<spacedim, Number>::is_admissible_or_small(Number       eta,
                                                       unsigned int n_min)
{
...
#endif // HIERBEM_INCLUDE_CLUSTER_TREE_BLOCK_CLUSTER_H_
