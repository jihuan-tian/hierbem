 ...
 * @author Jihuan Tian
 */
#ifndef INCLUDE_TRIANGULATION_TOOLS_H_
#define INCLUDE_TRIANGULATION_TOOLS_H_
                    ...
                    if (mat_id < material_id_shift)
                      {
                        ...
                        Assert(
                          face_iter_pos !=
                            map_from_surface_to_volume_mesh.cend(),
                          ExcMessage(
                        ...
                        interfacial_domain_material_ids.insert(
                          mat_id + material_id_shift);
                      }
                  }
              }
          }
