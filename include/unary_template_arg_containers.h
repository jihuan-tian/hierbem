 ...
 * @author Jihuan Tian
 */
#ifndef HIERBEM_INCLUDE_UNARY_TEMPLATE_ARG_CONTAINERS_H_
#define HIERBEM_INCLUDE_UNARY_TEMPLATE_ARG_CONTAINERS_H_
...
#endif // HIERBEM_INCLUDE_UNARY_TEMPLATE_ARG_CONTAINERS_H_
