 ...
 * @author Jihuan Tian
 */
#ifndef HIERBEM_INCLUDE_HMATRIX_HMATRIX_SYMM_H_
#define HIERBEM_INCLUDE_HMATRIX_HMATRIX_SYMM_H_
...
template <int spacedim, typename Number>
HMatrixSymm<spacedim, Number> &
HMatrixSymm<spacedim, Number>::operator=(
  HMatrixSymm<spacedim, Number> &&H) noexcept
{
...
#endif /* HIERBEM_INCLUDE_HMATRIX_HMATRIX_SYMM_H_ */
