...
public:
  ...
  CUDA_CALLABLE_MEMBER value_type
  real() const
  {
    return __re_;
  }
  ...
  real(value_type __re)
  {
    __re_ = __re;
  }
  CUDA_CALLABLE_MEMBER void
  imag(value_type __im)
  {
    __im_ = __im;
  }

  CUDA_CALLABLE_MEMBER complex &
  operator=(const value_type &__re)
  {
    __re_ = __re;
    __im_ = value_type();
    return *this;
...
public:
  ...
  /*constexpr*/ CUDA_CALLABLE_MEMBER
  ...
  /*constexpr*/ CUDA_CALLABLE_MEMBER float
  real() const
  {
    return __re_;
  }
...
public:
  ...
  /*constexpr*/ CUDA_CALLABLE_MEMBER double
  real() const
  {
    return __re_;
  }
...
template <class _Tp>
inline CUDA_CALLABLE_MEMBER complex<_Tp>
operator+(const complex<_Tp> &__x, const complex<_Tp> &__y)
{
  complex<_Tp> __t(__x);
  __t += __y;
...
template <class _Tp>
CUDA_CALLABLE_MEMBER complex<_Tp>
                     operator*(const complex<_Tp> &__z, const complex<_Tp> &__w)
{
  _Tp __a  = __z.real();
  _Tp __b  = __z.imag();
...
template <>
CUDA_CALLABLE_MEMBER complex<float>
...
template <class _Tp>
inline CUDA_CALLABLE_MEMBER _Tp
...
inline CUDA_CALLABLE_MEMBER double
imag([[maybe_unused]] double __re)
{
  return 0;
}

inline CUDA_CALLABLE_MEMBER float
imag([[maybe_unused]] float __re)
{
  return 0;
}
...
inline CUDA_CALLABLE_MEMBER complex<double>
                            conj(double __re)
{
  return complex<double>(__re);
}

inline CUDA_CALLABLE_MEMBER complex<float>
                            conj(float __re)
{
